            ...
            <div class="card rounded">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted">{{ $patient->user->phone }}</p>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        <label class="tx-11 font-weight-bold mb-0 text-uppercase">Client:</label>
                        <p class="text-muted">{{ $patient->client->user->name }}</p>
                    </div>
                    <div class="mt-3">
