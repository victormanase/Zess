...
@section('content')
    @component('components.form', [
        'size' => 12,
        'url' => $isEditing ? route('users.doctors.update', $doctor->id) : route('users.doctors.store'),
        'title' => $isEditing ? 'Edit Doctor' : 'Create a Doctor',
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <div>
                    <input type="text" class="form-control" id="" autocomplete="off" placeholder="Doctor name.." name="name"
